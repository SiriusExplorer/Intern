...
result_path1 = '/Users/liuzhen/intern/data/test/RPKM_gene_dpsfd_avglen_result.txt'
...
print('Df2 drop scaffold remove duplicates unique gene number:', df2_uniq_gene)
print('Common gene number:', common_gene)
